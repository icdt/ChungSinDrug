...
public class ValidateCode : IHttpHandler, IRequiresSessionState
{
    ...
    private string GenerateCheckCode(HttpContext context)
    {
        ...
        System.Random randomsize = new Random();
        number2 = randomsize.Next(4, 4);
        //number2 = randomsize.Next(2, 7);
    ...
    private void CreateCheckCodeImage(string checkCode, HttpContext context)
    {
        ...
        System.Drawing.Bitmap image = new System.Drawing.Bitmap((int)Math.Ceiling((checkCode.Length * 20.1)), 30);
